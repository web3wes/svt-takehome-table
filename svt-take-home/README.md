...
Things that I think would be interesting to addd would be:

1: More UI queue for the user, such as:
- An arrow that indicates if the row sorting in ascending or descending order. 
...
3: A fun animation the shows something ie Wall-e moving across a floor to show how far a given robot is from their goal. (this would probably be in a more details page a selected robot.)
